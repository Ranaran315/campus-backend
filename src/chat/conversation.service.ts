...
export class ConversationService {
  ...
  // 获取或创建私聊会话
  async getOrCreatePrivateConversation(userId1: string | Types.ObjectId, userId2: string | Types.ObjectId) {
  ...
  // 更新会话最后活动时间和最后一条消息
  async updateConversationActivity(conversationId: string | Types.ObjectId, messageId: string | Types.ObjectId) {
